...
<body>
	...
	<form name="form" class="box" action="getInfixServlet" method="post"
		autocomplete=off target="_blank">
		<h1>Postfix - Infix Converter</h1>
		...
		<input type="text" name="postfix" placeholder="For example, abc+*"><br>
